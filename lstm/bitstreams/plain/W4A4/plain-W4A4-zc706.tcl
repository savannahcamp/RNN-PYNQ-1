...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M00_AXI [get_bd_intf_pins ps7_axi_periph/M00_AXI] [get_bd_intf_pins topLevel_BLSTM_CTC_0/s_axi_control]
  connect_bd_intf_net -intf_net topLevel_BLSTM_CTC_0_m_axi_hostmem [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins topLevel_BLSTM_CTC_0/m_axi_hostmem]
